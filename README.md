...
**Infraestrutura e DevOps:** Gestão de containers com Docker e Portainer, configuração de proxy reverso com Nginx e Treafik, deploy automatizado, CI/CD e ambientes Linux.

**Banco de Dados:** MongoDB, PostgreSQL, Firebase(em nuvem), Supabase(em nuvem) modelagem e otimização de dados.
...
#### Infraestrutura, DevOps e Containers
